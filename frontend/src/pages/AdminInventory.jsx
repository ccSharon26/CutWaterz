                  ...
                  <td className="text-center">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button
                        ...
                        className="bg-blue-500 text-black px-3 py-1 rounded font-semibold hover:bg-blue-600 transition"
                      >
                        Save
                      </button>
                    </div>
        ...
        {products.length > 0 ? (
          products.map((p) => (
            ...
            >
              ...
              <p className="text-sm text-gray-300 mb-1">
                <strong>Price:</strong> Ksh {p.price}
              </p>
              ...
              <button
                onClick={() => handleDelete(p.id)}
                className="w-full mt-3 bg-red-600 text-white py-1 rounded font-semibold hover:bg-red-700 transition"
              >
                Delete
              </button>
            </div>
